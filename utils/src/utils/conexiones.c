...
int iniciar_servidor(char *puerto)
{
	...
	// imprimir_mensaje("Listo para escuchar a mi cliente"); // la comento, para q se emita fuera x log
...
int esperar_cliente(int socket_servidor_fd)
{
	...
	// imprimir_mensaje("Se conecto un cliente!"); // la comento, para q se emita fuera x log
